...
Tab5:AddButton({
	...
	Callback = function()
        repeat wait(5) until game:IsLoaded()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/AEMDxLongHip/ScriptHub/main/GenshinHubV2.lua"))()
end
})
Tab5:AddButton({
	...
	Callback = function()
        repeat wait(5) until game:IsLoaded()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/AEMDxLongHip/ScriptHub/main/GenshinHubV3.lua"))()
end
})